...
public class JuheDemo {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="f77324312d4e665eb69362d39c796a53";
  ...
  public static String post(String type,File file) throws Exception{
            ...
            try {
                ...
                if (resEntity != null) {
                    ...
                    //内容的编码格式    
                    System.out.println(resEntity.getContentEncoding());    
                    //内容的长度    
                    System.out.println(resEntity.getContentLength());    
                    //把内容转成字符串    
                    System.out.println("内容转成字符串   :"+EntityUtils.toString(resEntity));  
//                    result =resEntity.getContent().toString();
...
//                    result =IOUtils.toString(resEntity.getContent(), "UTF-8");
    ...
    public static void main(String[] args) {
        File file = new File("/Users/jiang/Downloads/yzm.jpg");
        try {
            post("1005",file);
        } catch (Exception e) {
            e.printStackTrace();
